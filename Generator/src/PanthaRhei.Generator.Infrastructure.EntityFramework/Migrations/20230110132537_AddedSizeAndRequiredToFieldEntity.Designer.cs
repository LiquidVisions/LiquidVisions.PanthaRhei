...
namespace LiquidVisions.PanthaRhei.Generator.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20230110132537_AddedSizeAndRequiredToFieldEntity")]
    partial class AddedSizeAndRequiredToFieldEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiquidVisions.PanthaRhei.Generator.Domain.Entities.Relationship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LiquidVisions.PanthaRhei.Generator.Domain.Entities.Relationship", b =>
                {
                    ...
                    b.HasOne("LiquidVisions.PanthaRhei.Generator.Domain.Entities.Field", "Key")
                        .WithMany("RelationshipKeys")
                        .HasForeignKey("KeyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("LiquidVisions.PanthaRhei.Generator.Domain.Entities.Entity", "WithForeignEntity")
                        .WithMany("IsForeignEntityOf")
                        .HasForeignKey("WithForeignEntityId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("LiquidVisions.PanthaRhei.Generator.Domain.Entities.Field", "WithForeignEntityKey")
