...
{
    internal class DeleteAppInteractor : IInteractor<DeleteAppCommand>
    {
        private readonly IValidator<DeleteAppCommand> validator;
        ...
        public async Task<Response> ExecuteUseCase(DeleteAppCommand requestModel)
        {
