...
namespace LiquidVisions.PanthaRhei.Expanders.CleanArchitecture.Handlers.Client
{
    ...
    public class ExpandClientHandlerInteractor : IExpanderHandlerInteractor<CleanArchitectureExpander>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpandClientHandlerInteractor"/> class.
        /// </summary>
        /// <param name="expander"><seealso cref="CleanArchitectureExpander"/></param>
        /// <param name="dependencyFactory"><seealso cref="IDependencyFactoryInteractor"/></param>
        public ExpandClientHandlerInteractor(CleanArchitectureExpander expander, IDependencyFactoryInteractor dependencyFactory)
        {
        ...
        public string Name => nameof(ExpandClientHandlerInteractor);
