...
{
    public class ExpandSecretsTask : IExpanderTask<CleanArchitectureExpander>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpandSecretsTask"/> class.
        /// </summary>
        /// <param name="expander"><seealso cref="CleanArchitectureExpander"/></param>
        /// <param name="dependencyFactory"><seealso cref="IDependencyFactory"/></param>
        public ExpandSecretsTask(CleanArchitectureExpander expander, IDependencyFactory dependencyFactory)
        {
        ...
        public string Name => nameof(ExpandSecretsTask);
