...
namespace LiquidVisions.PanthaRhei.Expanders.CleanArchitecture.Handlers.Domain
{
    ...
    /// </summary>
    public class ExpandEntitiesTask : IExpanderTask<CleanArchitectureExpander>
    {
        ...
        public ExpandEntitiesTask(CleanArchitectureExpander expander, IDependencyFactory dependencyFactory)
        {
