...
namespace LiquidVisions.PanthaRhei.Expanders.CleanArchitecture.Handlers.Api
{
    ...
    /// </summary>
    public class ExpandEndpointsTask : IExpanderTask<CleanArchitectureExpander>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpandEndpointsTask"/> class.
        /// </summary>
        /// <param name="expander"><seealso cref="CleanArchitectureExpander"/></param>
        /// <param name="dependencyFactory"><seealso cref="IDependencyFactory"/></param>
        public ExpandEndpointsTask(CleanArchitectureExpander expander, IDependencyFactory dependencyFactory)
        {
        ...
        /// <inheritdoc/>
        public string Name => nameof(ExpandEndpointsTask);
